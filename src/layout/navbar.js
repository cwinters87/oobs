    ...
    <div className={styles.sectionWrapper}>
      <Navbar expand="lg" className={styles.navBar} style={navBarStyle}>
        <div id={styles.logoWrapper}>
          <Link id={styles.linkImgContainer} to="/">
              ...
              <Offcanvas.Body id={styles.offCanvasBody}>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  <div id={styles.linkContainerOne} style={LinkContainerStyle}>
                    ...
                    <Link to="/lenders" onClick={handleClose}>
                      For Lenders
                    </Link>
                    <Link to="/brokers" onClick={handleClose}>
                      For Brokers
                    </Link>
                    <Link to="/about" id={styles.about} onClick={handleClose}>
                      About
                    </Link>
                  </div>
