...
const cardData = [
  ...
  {
    imageUrl: backgroundImg,
    quote: 'TaskSuite has provide ongoing support and valuable insight as to how we can continue to utilize these tools to increase productivity and operate our business efficiently.',
    author: 'Brandon Hoye',
    position: 'CTO',
