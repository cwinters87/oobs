            ...
            <div className={styles.container}>
                ...
                <div className={styles.cardContainer}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.title}><h3>Expanded reach</h3></div>
                        <div className={styles.subTitle}><p>By connecting with a diverse network of brokers, you'll have access to a broader range of loan deals, helping you grow your business and diversify your portfolio.</p></div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.image}><img src={imageTwo} alt="data icon"/></div>
                        <div className={styles.title}><h3>Improved efficiency</h3></div>
                        <div className={styles.subTitle}><p>Our platforms automation capabilities streamline your loan processing workflow, enabling you to focus on making the best decisions for your business.</p></div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.image}><img src={imageThree} alt="experience icon"/></div>
                        <div className={styles.title}><h3>Enhanced relationships</h3></div>
                        <div className={styles.subTitle}><p>with seamless communication through our platform, you'll build stronger relationships with brokers, increasing the likelihood of repeat business and long-term partnerships.</p></div>
                    </div>
                    <div className={styles.card}>
