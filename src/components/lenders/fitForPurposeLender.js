            ...
            <div className={styles.container}>
                <div className={styles.textContainer}>
                    <h2 className={styles.title}>
                        Lenders deserve their own fit-for-purpose <br className={styles.topBreakPoint}/>comprehensive platform.
                    </h2>
                    <p className={styles.subTitle}>
                        In the competitive lending industry, connecting with the right brokers and <br className={styles.middleBreakPoint}/>securing high-quality loan deals is crucial for your success. As a pioneering  <br className={styles.middleBreakPoint}/>loan software SaaS company, TaskSuite has developed a cutting-edge <br className={styles.middleBreakPoint}/>solution to help lenders like you thrive.
                    </p>
                </div>
