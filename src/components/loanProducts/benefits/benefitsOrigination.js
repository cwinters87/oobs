        ...
        <div className={styles.sectionWrapper}>
            <div className={styles.container}>
                ...
                <div className={styles.card}>
                    <div className={styles.image}><img src={imageOne} alt="compliance icon"/></div>
                    <div className={styles.title}><h3>Automated Regulation Compliance</h3></div>
                    <div className={styles.subTitle}><p>TaskSuite helps lenders stay compliant with regulations by automating compliance checks and providing necessary documentation.</p></div>
                </div>
                <div className={styles.card}>
                    ...
                    <div className={styles.subTitle}><p>TaskSuite automates many tasks involved in the loan process, resulting in faster loan approvals, processing, and disbursals.</p></div>
                </div>
                <div className={styles.card}>
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.subTitle}><p>Real-time data on loan performance and defaults powers better-informed decisions, helping mitigate potential risks and reduce loan defaults.</p></div>
                </div>
                <div className={styles.card}>
