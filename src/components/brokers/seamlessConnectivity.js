            ...
            <div className={styles.container}>
                ...
                <div className={styles.cardContainer}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.title}><h3>Competitive edge</h3></div>
                        <div className={styles.subTitle}><p>By harnessing the power of TaskSuite, you'll stay ahead of your competitors and secure the best loan deals for your clients</p></div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.image}><img src={imageTwo} alt="data icon"/></div>
                        <div className={styles.title}><h3>Enhanced client experience</h3></div>
                        <div className={styles.subTitle}><p>With faster loan processing and a seamless user interface, your clients will enjoy a stress-free experience, increasing their trust in your services and their likelihood of returning for future transactions.</p></div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.image}><img src={imageThree} alt="experience icon"/></div>
                        <div className={styles.title}><h3>Increased efficiency</h3></div>
                        <div className={styles.subTitle}><p>By automating the process of submitting loan applications and receiving offers, our platform allows you to spend more time on what matters - building relationships with your clients and growing your business.</p></div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.image}><img src={imageFour} alt="workflow icon"/></div>
                        <div className={styles.title}><h3>Customizable solution</h3></div>
