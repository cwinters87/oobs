      ...
      <div className={styles.container}>
        <div className={styles.textContainer}>
          <h2 className={styles.title}>
            Brokers deserve their own fit-for-purpose{" "}
            <br className={styles.topBreakPoint} />
            comprehensive platform.
          </h2>
          <p className={styles.subTitle}>
            Brokers need to stay ahead of the game to provide clients with the
            best loan options in the shortest time{" "}
            <br className={styles.middleBreakPoint} />
            possible. As a leading loan software SaaS company, TaskSuite has
            developed a comprehensive loan{" "}
            <br className={styles.middleBreakPoint} />
            management and processing solution specifically designed for brokers
            like you.
          </p>
        </div>
