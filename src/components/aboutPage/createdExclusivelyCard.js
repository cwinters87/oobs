          ...
          <div className={styles.container}>
            <div className={styles.textContainer}>
                <div className={styles.middleWrapper}>
                    ...
                    <p className={styles.subTitle}>We understand the complexities and nuances of the loan <br className={styles.bottomBreakPoint}/>industry, which is why we've been able to ensure our <br className={styles.bottomBreakPoint}/>solution is tailored to meet your needs and use cases.</p>
